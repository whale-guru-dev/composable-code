...
export const transactionSettingsOptionsSlice = createSlice({
    ...
    initialState,
    reducers: {
        setSlippage: (state, payload: PayloadAction<TransactionSettingsOptions["slippage"]>) => {
            state.slippage = payload.payload;
        },
        setDeadline: (state, payload: PayloadAction<TransactionSettingsOptions["deadline"]>) => {
